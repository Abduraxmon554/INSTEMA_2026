    ...
    gallery: {
      ...
      videos: [
        ...
        },
        {
          ...
          caption: "Juan José Boscà — amaliyotdan yangi lavha",
        },
        {
          id: "testimonial",
    ...
    gallery: {
      ...
      videos: [
        ...
        },
        {
          ...
          src: "/media/videos/profile-session.mp4",
          poster: "/media/videos/profile-session-poster.jpg",
          caption: "Juan José Boscà — nuevo fragmento de práctica",
        },
        {
          id: "testimonial",
          src: "/media/videos/testimonial.mp4",
    ...
    gallery: {
      ...
      videos: [
        ...
        },
        {
          ...
          src: "/media/videos/profile-session.mp4",
          poster: "/media/videos/profile-session-poster.jpg",
          caption: "Juan José Boscà — new clip from practice",
        },
        {
          id: "testimonial",
          src: "/media/videos/testimonial.mp4",
    ...
    gallery: {
      ...
      videos: [
        ...
        },
        {
          ...
          src: "/media/videos/profile-session.mp4",
          poster: "/media/videos/profile-session-poster.jpg",
          caption: "Хуан Хосе Боска — новый фрагмент практики",
        },
        {
          id: "testimonial",
          src: "/media/videos/testimonial.mp4",
